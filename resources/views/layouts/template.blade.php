            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="index.html">NH</a>
                    </div>
                    <ul class="sidebar-menu">
                        <!-- <li class="menu-header">Dashboard</li> -->
                        <li><a class="nav-link" href="{{ route('home') }}"><i class="fas fas fa-fire"></i> <span>Dashboard</span></a></li>
                        <!-- <li class="menu-header">Master Data</li> -->
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Master Data</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('yayasan') }}">Master Data Yayasan</a></li>
                                <li><a class="nav-link" href="{{ route('tagihan-master') }}">Master Data Tagihan</a></li>
                                <li><a class="nav-link" href="{{ route('santri') }}">Master Data Santri</a></li>
                            </ul>
                        </li>
                        <li class="menu-header">Tagihan</li>
                        <li><a class="nav-link" href="{{ route('home') }}"><i class="fas fas fa-fire"></i> <span>Tagihan - Tagihan</span></a></li>

                        <li class="menu-header">Laporan</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Tagihan</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('yayasan') }}">Laporan per Santri</a></li>
                                <li><a class="nav-link" href="{{ route('tagihan-master') }}">Laporan Tahunan</a></li>
                            </ul>
                        </li>
